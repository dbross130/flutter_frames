...
import 'ccms_managersview.dart';

class Ccms extends StatefulWidget {
  const Ccms({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CcmsState createState() => _CcmsState();
}

class _CcmsState extends State<Ccms> {
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const CcmsManagersview(),
                      )),
                  child: Container(
                    decoration: BoxDecoration(
